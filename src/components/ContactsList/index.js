...
class ContactsList extends Component {
  ...
  onClickLeft = (event) => {
    ...
    if (pageNo !== 1) {
      this.setState((prevState) => ({
        ...
        contacts: names.slice(
          (prevState.pageNo - 2) * 5,
          (prevState.pageNo - 1) * 5
        ),
      }));
    }
  };
  ...
  onClickRight = () => {
    ...
    if (pageNo !== 10) {
      this.setState((prevState) => ({
        pageNo: prevState.pageNo + 1,
        contacts: names.slice(prevState.pageNo * 5, (prevState.pageNo + 1) * 5),
      }));
    }
  };
      ...
      <div>
        ...
        <div>
          ...
          <div className="bottom-container">
              <button className="btn controllers" type="button" onClick={this.onClickLeft}>
                <AiOutlineLeft />
              </button>
              Page {pageNo} of 10
              <button className="btn controllers" type="button" onClick={this.onClickRight}>
                <AiOutlineRight />
              </button>
          </div>
        </div>
